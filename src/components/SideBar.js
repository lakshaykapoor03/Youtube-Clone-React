  ...
  return (
    <div className="mt-20  bg-white">
        ...
        <div  className="w-14 md:w-28">
          ...
          <Link to="/">  <li className=" flex flex-col md:flex-row  items-center text-xs cursor-pointer">
            <i className="fa-sharp fa-solid fa-house mr-2"></i>Home</li>
              </Link>
          
            <li className=" flex flex-col md:flex-row  gap-2  items-center text-xs">
              <i className="fa-regular fa-file-video"></i>Shorts
            </li>
            <li className="flex gap-2 flex-col md:flex-row items-center text-xs">
